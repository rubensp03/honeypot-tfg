"""
Figura Híbrida 1: Volumen general del pipeline híbrido (barras apiladas horizontales).
Datos: honeypot_hibrido_deepseek.db (tabla alertas_hibrido)
"""
import os
import sqlite3
import pandas as pd
...
def main():
    setup_style()
    ensure_dirs()
    trans = TRANSLATIONS['fig_hibrido_1']
    ...
    for lang in ['es', 'en']:
        ...
        # Barras apiladas horizontales: una sola barra con las dos partes
        # O mejor: dos barras separadas con valores
        ...
        fig.tight_layout()
        save_fig(fig, 'fig_hibrido_1_volumen_general', lang)
        plt.close(fig)
    print("[hibrido_1] OK")
